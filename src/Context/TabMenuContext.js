...
const TabMenuReducer = (state, action) => {
  switch (action.type) {
    ...
    case 'JobScheduling_Jobs':
      return { TabJobSchedule: 0, SubActiveValue: 4 };
    case 'JobScheduling_Schedule':
      return { TabJobSchedule: 1, SubActiveValue: 5 };
    case 'JobScheduling_Calender':
      return { TabJobSchedule: 2, SubActiveValue: 6 };
    case 'JobScheduling_Application':
      return { TabJobSchedule: 3, SubActiveValue: 7 };
    case 'JobScheduling_ApplicationTemplate':
      return { TabJobSchedule: 4, SubActiveValue: 8 };
